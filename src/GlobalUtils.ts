...
//   // filename are provided in a single variable. Using one single file location variable
...
//   // Note: the file extension ".json" is required to be concatenated separately for the
//   // dynamic import of JSON files to work properly.
//   // See https://github.com/rollup/plugins/tree/master/packages/dynamic-import-vars#limitations
//   // for supported dynamic import formats.
//   const paletteJson = await import(`${jsonFilePath}.json`);  /* @vite-ignore */
//   return paletteJson;
// }
